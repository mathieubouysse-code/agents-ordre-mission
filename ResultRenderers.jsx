/**
 * AGENTS — définition des 5 agents du pipeline.
 * Chaque agent a un identifiant, un nom, un style visuel,
 * une description de son rôle, et son prompt système.
 */
export const AGENTS = {
  auditeur: {
    id: "auditeur",
...
Réponds UNIQUEMENT avec un JSON valide (sans markdown) :
{
  "corrections": [{"bug_id":"BUG-01","titre":"titre court","avant":"code avant (max 80 chars)","apres":"code après (max 80 chars)","explication":"pourquoi c'était un bug"}],
